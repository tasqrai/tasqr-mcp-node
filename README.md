...
[![ci](https://github.com/tasqrai/tasqr-mcp-node/actions/workflows/ci.yml/badge.svg)](https://github.com/tasqrai/tasqr-mcp-node/actions/workflows/ci.yml)
[![npm](https://img.shields.io/npm/v/tasqr-mcp)](https://www.npmjs.com/package/tasqr-mcp)
...
```bash
claude mcp add --scope project tasqr -- npx -y tasqr-mcp   # .mcp.json in the project, shareable via git
claude mcp add --scope user tasqr -- npx -y tasqr-mcp      # ~/.claude.json, every project
```
...
| Level             | Logs                                                                          |
| ----------------- | ----------------------------------------------------------------------------- |
| `off` _(default)_ | nothing — no file is created                                                  |
